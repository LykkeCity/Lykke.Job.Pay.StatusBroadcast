...
namespace Lykke.Job.Pay.StatusBroadcast
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            builder.RegisterModule(new JobModule(appSettings.CurrentValue.StatusBroadcastJob, log));
...

        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.StatusBroadcastJob.Db.LogsConnString);
